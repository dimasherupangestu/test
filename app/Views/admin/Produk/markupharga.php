			...
			<div class="col-md-12">
				...
				<div class="row justify-content-center">
					<div class="col-md-10">
						<div class="card">
							<div class="card-body">
								<h5 class="mb-3 text-dark">Markup Harga Produk</h5>
								<p class="text-dark">Update Harga Jual berdasar kenaikan persentase atau penambahan nominal dari Harga Modal</p>

								<?= alert(); ?>

								<form action="" method="POST" enctype="multipart/form-data">
									<div class="form-group row">
										<label class="col-form-label col-md-4 text-dark">Pilih Tipe</label>
										<div class="col-md-8">
											<select name="tipeharga" class="form-control">
												<option value="publik">Harga Publik</option>
												<option value="bronze" >Harga Member Biasa</option>
												<option value="silver" >Harga Reseller Silver</option>
												<option value="gold" >Harga Reseller Gold</option>
												<option value="platinum" >Harga Reseller Platinum</option>
												<option value="discount_price" >Harga Coret</option>
									...
									<div class="form-group row">
										<label class="col-form-label col-md-4 text-dark">Pilih Provider</label>
										<div class="col-md-8">
									...
									<div class="form-group row">
										<label class="col-form-label col-md-4 text-dark">Markup by Persentase (%)</label>
										<div class="col-md-8">
											<input placeholder="10" value="5" type="text" class="form-control" autocomplete="off" name="persentase">
											<p class="text-dark">isi 0 jika tidak ingin ada penambahan harga by Persentase</p>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-form-label col-md-4 text-dark">Markup by Nominal (Rp)</label>
										<div class="col-md-8">
											<input placeholder="1000" value="0" type="text" class="form-control" autocomplete="off" name="nominal">
											<p class="text-dark">isi 0 jika tidak ingin ada penambahan harga by Nominal</p>
										</div>
									</div>
