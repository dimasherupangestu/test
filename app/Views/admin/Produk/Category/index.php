							...
							foreach ($category as $loop): ?>
								<tr>
									...
									<td width="10">
										...
										<a href="<?= base_url(); ?>admin/produk/category/delete/<?= $loop['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Hapus</a>
									</td>
								</tr>
							<?php endforeach ?>
						</table>
