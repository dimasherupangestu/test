            ...
            <div class="col-md-12 my-4">
                <div class="card">
                    ...
                    <div class="table-responsive table-white ">
                        <table id="table" data-sort-select-options="true"
                            data-page-size="100" data-sort-name="games" data-sort-order="asc" data-toggle="table" data-search-highlight="true" data-filter-control="true"
                            data-pagination="true" class="table table-white table-striped" data-search="true" data-advanced-search="true" data-id-field="id"
                            data-toolbar="#toolbar" data-show-toggle="true" data-show-columns="true" data-searchable="true" data-show-search-clear-button="true" data-url=""
                            data-show-export="true" data-page-list="[10, 25, 50, 100, 200]" data-export-types="['excel']" data-side-pagination="server"
