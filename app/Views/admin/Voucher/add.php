                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row <?= isset($voucher['type_produk']) && $voucher['type_produk'] == 'all' ? 'd-none' : ''; ?>" id="type_custom2">
                                        <label class="col-form-label col-md-4 text-white">Pilih Level Membership</label>
                                        <div class="col-md-8">
                                            <?php
                                            $selected_levels = [];
                                            if (isset($voucher['type_produk']) && $voucher['type_produk'] == 'custom') {
                                                $selected_levels = explode(',', $voucher['level']);
                                            }
                                            ?>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="level-Member" name="level[]" value="Member">
                                                <label class="custom-control-label text-white" for="level-Member" style="padding-top: 4px;"> Member Biasa</label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="level-Publik" name="level[]" value="Publik">
                                                <label class="custom-control-label text-white" for="level-Publik" style="padding-top: 4px;">Publik</label>
                                            </div>
                                        </div>
                                    </div>
