        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <?php
                    //  if ($admin['level'] !== 'Customer Service' && $admin['level'] !== 'Product Development'): 
                    ?>
                    <li class="nav-item">
                    ...
                    ?>
                    <?php
                    // if ($admin['level'] == 'Superadmin' || $admin['level'] == 'Product Development'): 
                    ?>
                    <li class="nav-item">
                    ...
                    <?php
                    //  if ($admin['level'] !== 'Product Development') : 
                    ?>
                    <li class="nav-item">
                    ...
                    <?php
                    // if ($admin['level'] !== 'Customer Service'):
                    ?>
                    ...
                    <?php
                    // if ($admin['level'] !== 'Admin' && $admin['level'] !== 'Customer Service') :
                    ?>
                    <li class="nav-item">
