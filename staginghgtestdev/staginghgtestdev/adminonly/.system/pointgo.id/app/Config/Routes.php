...
$routes->match(['get', 'post'], '/loginAdminOnlyH1D5EnGa6ame', 'Pages::loginAdminOnlyH1D5EnGa6ame');
$routes->match(['get', 'post'], '/loginreseller', 'Pages::loginreseller');
$routes->match(['get', 'post'], '/logout', 'Pages::logout');
$routes->match(['get', 'post'], '/register', 'Pages::register');
$routes->match(['get', 'post'], '/registerreseller', 'Pages::registerreseller');
$routes->match(['get', 'post'], '/registerotp', 'Pages::register');
$routes->match(['get', 'post'], '/register/(:any)', 'Pages::register/$1');
$routes->match(['get', 'post'], '/forgotpass', 'Pages::forgotpass');
$routes->match(['get', 'post'], '/resetpasslink/(:any)', 'Pages::resetpasslink/$1');
$routes->match(['get', 'post'], '/reseller', 'Pages::reseller');
...
$routes->match(['get', 'post'], '/adm1npointg01419', 'Admin\Home::login');
$routes->match(['get', 'post'], '/hello', 'Admin\Home::hello');
$routes->match(['get', 'post'], '/admin/newdashboard', 'Admin\Home::newdashboard');
$routes->match(['get', 'post'], '/admin/laporan', 'Admin\Home::laporan');
$routes->match(['get', 'post'], '/admin/laporanbackup', 'Admin\Home::laporanbackup');
...
$routes->match(['get', 'post'], '/admin/pesanan/pending', 'Admin\Pesanan::pending');
$routes->match(['get', 'post'], '/admin/pesanan/processing', 'Admin\Pesanan::processing');
$routes->match(['get', 'post'], '/admin/pesanan/canceled', 'Admin\Pesanan::canceled');
$routes->match(['get', 'post'], '/admin/pesanan/success', 'Admin\Pesanan::success');
$routes->match(['get', 'post'], '/admin/pesanan/topup', 'Admin\Pesanan::topup');
$routes->match(['get', 'post'], '/admin/pesanan/manual', 'Admin\Pesanan::manual');
...
$routes->match(['get', 'post'], '/user/settings', 'User::settings');
...
$routes->match(['get', 'post'], '/user/all-games', 'User\Home::index');
$routes->match(['get', 'post'], '/user/games/voucher/(:num)/', 'User\Games::voucher/$1');
$routes->match(['get', 'post'], '/user/games/order/(:any)/(:any)', 'User\Games::order/$1/$2');
$routes->match(['get', 'post'], '/user/games/(:any)', 'User\Games::index/$1');

$routes->match(['get', 'post'], '/user/payment', 'User\Payment::detail');
$routes->match(['get', 'post'], '/user/payment/(:any)', 'User\Payment::index/$1');
$routes->match(['get', 'post'], '/user/tabelharga', 'User::tabelharga');
$routes->match(['get', 'post'], '/user/laporan', 'User::laporan');
