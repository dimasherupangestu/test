			                    ...
			                    <div class="card">
			                        <div class="card-body">
    			                        <div class="table-responsive">
                                            ...
                                            data-url="<?= base_url(); ?>/user/get_riwayat_topup">
                                            <thead>
                                                <tr>
                                                    <th data-field="topup_id" >No Topup</th>
                                                    <th data-field="method">Metode</th>
                                                    <th data-field="amount">Nominal</th>
                                                    <th data-field="status">Status</th>
                                                    <th data-field="date_create">Tanggal</th>
                                                </tr>
                                            </thead>
                                        </table>
    			                        </div>
