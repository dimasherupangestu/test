					                    ...
					                    <div class="row">
					                        <div class="col-sm-6">
					                            ...
					                            <?php if ($topup['status'] == 'Pending'): ?>
                    								...
                    								<?php if (($topup['payment_type'] == 'QRIS' && $topup['payment_gateway'] == 'Xendit') || (in_array($topup['payment_type'], ['QRIS']) && $topup['payment_gateway'] == 'Duitku') || ($topup['payment_type'] == 'QRIS' && $topup['payment_gateway'] == 'Ipaymu')) : ?>
