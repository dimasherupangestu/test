        ...
        <div class="content">
			<div class="pb-5">
			    <div class="container5">
			        ...
			        <div class="row">
					    <div class="pb-3 ">
					    	<div class="pt-3" id="lsg-home">
					            <h5 style="font-size: 28px;text-align:center;padding-bottom:15px">Detail Top Up</h5>
					        </div>
					        <div class="pb-3">
					            <div class="card">
					                <div class="card-body trims-1" style="border-radius: 10px 10px 0px 0px;">
										...
										<h5><b class="d-block mt-2"><?= $topup['payment_code']; ?><i class="fa fa-clone pl-2 clip" onclick="copy_rek()" data-clipboard-text="<?= $topup['payment_code']; ?>"></i></b></h5>
					                        ...
					                        <div class="col-sm-12">
					                            <div class="pb-4"> No. Transaksi 
					                            	<h5>
					                            		TP<?= $topup['topup_id']; ?> <i class="fa fa-clone pl-2 clip" onclick="copy_trx()" data-clipboard-text="TP<?= $topup['topup_id']; ?>"></i>
					                                </h5>
					                            </div>
