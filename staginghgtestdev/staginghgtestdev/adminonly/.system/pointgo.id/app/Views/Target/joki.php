<div class="form-row pt-3">
    ...
    <div class="col-lg-6">
        <input type="text" name="joki[rank_awal]" class="form-control mb-2 name-joki" placeholder="Rank Awal" autocomplete="off">
    </div>
    <div class="col-lg-6">
        <input type="text" name="joki[rank_tujuan]" class="form-control mb-2 name-joki" placeholder="Rank Tujuan" autocomplete="off">
    </div>
    <div class="col-lg-6">
        <input type="text" name="joki[request_hero]" class="form-control mb-2 name-joki" placeholder="Catatan (Request Hero)" autocomplete="off">
    </div>
    <div class="col-lg-6">
