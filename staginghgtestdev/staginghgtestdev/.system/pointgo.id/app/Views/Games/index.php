...
@media (min-width:320px) and (max-width:768px){
    ...
    width: auto;
    height: 140px;
    border-left: 2px solid #fff; border-top: 2px solid #fff; border-right: 2px solid #fff; 2px solid #fff; border-bottom: 2px solid #fff;
    border-radius: 20px 20px 20px 20px;
    }
...
@media (min-width:769px) {
    ...
    display: none;
    height: 140px;
    border-left: 2px solid #fff; border-top: 2px solid #fff; border-right: 2px solid #fff; 2px solid #fff;
    }
...
.ribbon {
    ...
    width: 10px; /* Atur lebar scrollbar */
}
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="bg-product-2" style="margin-bottom:20px; " >
                    <div style="background: url(<?= base_url(); ?>/assets/images/games/banner_img/<?= $games['banner_img']; ?>); background-size:cover; background-repeat:no-repeat" alt="slide " class="bg-banner-new-2"><div class="pt-3 pb-2" >
                            <img src="<?= base_url(); ?>/assets/images/games/<?= $games['image']; ?>" class="mb-3"
            ...
            <div class="col-sm-6 fixed-position-2">
                ...
                <!--<div class="pb-3">-->
                <!--        <div class="body-games shadow-form">-->
                <!--            <h5 style="color:var(--warna_2) !important;">PRODUK FLASHSALE</h5>-->
                <!--            <div id="<?= $loop['id']; ?>" class="col-6 col-lg-4" style="padding-right: 5px;padding-left: 5px;display:grid;" data-flashsale-part="<?= $loop['flashsale_part']; ?>">-->
                <!--                <input type="radio" for="product-<?= $loop['id']; ?>" id="product-<?= $loop['id']; ?>" class="radio-nominale" name="product" value="<?= $loop['id']; ?>" onchange="get_price(this.value);get_price_and_scroll(this.value);" onclick="toggleElement()">-->
                <!--                    <label for="product-<?= $loop['id']; ?>" <?= ($loop['limitflashsale'] > 0) ? 'style="background: linear-gradient(45deg , #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD , #E1EEDD, #E1EEDD, #E1EEDD , #E1EEDD, #E1EEDD , #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD, rgba(255, 255, 255, 1) 50%, #E1EEDD , #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD , #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD, #E1EEDD ); -->
                <!--                                    background-size: 700% 200%;-->
                <!--                                    animation: gradientAnimation 1.5s linear infinite;"' : '' ?>>-->
                <!--                        <div style="text-align: center;margin-bottom:10px;margin-top:10px;">-->
                ...
                <div class="pb-3">
                    <div class="section section-game" id="pembayaran-section"
                        ...
                        <div class="card-body-2">
                                <div class="cek-pembayaran">
                                    <hp class="text-left pb-3 text-white" style="font-size:20px; font-weight:600">Pilih Pembayaran</p>
                                </div>
                            </div>
                        <div class="body-games shadow-form">
                            <!--<h5 style="color:var(--warna_2) !important;">Pilih Pembayaran</h5>-->
                            <?php 
$combinedString = strtolower($product['product'] . ' ' . $games['games'] . ' ' . $games['category']);
...
?>
                                    ...
                                    <div class="accordion-button single-payment">
                                        ...
                                        <label for="method-balance" class="mb-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="diskon" id="price-method-diskon-balance"><span id="price-diskon-balance"></span></div>
                                                ...
                                                <div class="col-4 d-flex align-items-center">
                                                    <div>
                                                        ...
                                                        <div style="color: var(--warna_hitam);">Saldo: Rp <?= number_format($users['balance'], 0, ',', '.'); ?></div>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <div class="mt-2 text-right">
                                                        <!--<p class="m-0 harga-price-method" id="price-method-balance" style="color:var(--warna_hitam)!important;"></p>-->
                                                        <p class="m-0 harga-price-method" id="price-member-method-balance" style="color:var(--warna_hitam)!important;"></p>
                                                        <p class="m-0 balancedisc" id="price-method-disc-balancedisc"></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                    ...
                    <div class="section section-game" id="pembayaran-section"
                        ...
                        <div class="body-games shadow-form">
                            <!--<h5 style="color:var(--warna_2) !important;">Pembayaran</h5>-->
                            ...
                            <!--<div class="d-flex gap-2 pt-5 resp " style="padding-top:1rem !important">-->
                            <!--    <h5 style="color:var(--warna_2) !important;">Kode Voucher</h5><i style="opacity:0.5;color: #eee;"> (Opsional)</i>-->
                            <!--</div>-->
                            <?php if ($is_mobile == false): ?>
                            <!--<div class="form-group pt-3 resp">-->
                ...
                <div class="pb-3">
                    <div class="section">
                        <div class="d-flex card-body-2">
                                <div class="bukti-trx">
                                    <hp class="text-left pb-3 text-white" style="font-size:20px; font-weight:600">Kode Promo</p>
                                </div>
                            </div>
                        <div class="body-games shadow-form">
                            <div class="form-group pt-3 resp">
                ...
                <div class="pb-3">
                    <div class="section">
                        <div class="d-flex card-body-2">
                                <div class="bukti-trx">
                                    <hp class="text-left pb-3 text-white" style="font-size:20px; font-weight:600">Bukti Transaksi</p>
                                </div>
                            </div>
                        <div class="body-games shadow-form">
                            ...
                            <div class="form-group pt-3">
                                <p style="font-size: 12px;color:#333333 !important;">Opsional : Masukkan email kalian jika ingin mendapatkan bukti transaksi & promo menarik lainnya</p>

                                <input type="email" name="email_order" placeholder="Alamat E-Mail" class="form-control"
                                    value="">

                                <small class="mt-2 d-block mb-3 white" style="color:#333333 !important;">
...
<script>
    ...
    function turnProductOff(productId) {
        ...
        xhr.send(JSON.stringify({ productId: productId, status: "off" }));
    }
    ...
    function turnProductOn(productId) {
        ...
        xhr.send(JSON.stringify({ productId: productId, status: "on" }));
    }
        ...
        success: function(result) {
            for (let price in result) {
               ...
               if (result[price].price_disc && result[price].price_member) {
                ...
                if (tpbcava !== null) {tpbcava.innerHTML = 'Rp ' + (Math.round((harga * 1.01)+ 4200)).toLocaleString('id-ID');}
