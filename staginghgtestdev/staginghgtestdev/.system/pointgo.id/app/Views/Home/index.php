...
<style>
    .diskon {
        ...
        di -webkit-font-smoothing: antialiased;
        position: absolute;
        top: 0;
        right: 0;
        font-size: .875rem;
    ...
    <div class="swiper-container two">
        <div class="swiper-wrapper">
            <?php foreach ($flashsale as $flashsales) : ?>
                <div class="swiper-slide slide-container <?= ($flashsales['limitflashsale'] == 0) ? 'sold-out' : ''; ?>">
                    <div class="slide-content">
                        <?php if ($flashsales['limitflashsale'] > 0) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <div class="diskon-flashsale <?php echo ($flashsales['limitflashsale'] > 0) ? 'show-animation' : ''; ?>">
                                    <span class="limit-text" style="color:#fff;">
                                        <?php if ($flashsales['limitflashsale'] > 0) : ?>
                                            Tersisa : <span class="fire-effect"><?= $flashsales['limitflashsale']; ?>
                                            </span>
                                        <?php else : ?>
                                            Sold Out !
                                        <?php endif; ?>
