            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="get" action="<?= base_url('admin/home/laporan') ?>">
                                    <div class="row">
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-3 d-flex align-items-center gap-2">
                                            ...
                                            ?>
                                            <a href="<?= base_url() ?>/Admin/Home/exportDataFilter?<?= $paramString ?>" id="exportLink" class="btn btn-success">Export Data to CSV</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="card">
                    ...
                    <table id="table" data-search="true" data-advanced-search="true" data-id-field="id"
                        ...
                        data-url="<?= base_url(); ?>/admin/home/get_orders_data?<?= $paramString ?>" data-show-export="true" 
