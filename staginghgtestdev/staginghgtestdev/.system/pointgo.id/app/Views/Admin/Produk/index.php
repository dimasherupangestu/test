...
<style>
 ...
 .btn-toggle[data-status="Off"]:active, .btn-toggle[data-status="Off"]:hover, .btn-toggle[data-status="Off"]:focus {
     background: #bdc1c8;
 }
#popup {
    display: none;
				...
				<div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6 select">
                            <label for="games-filter">Filter by Games:</label>
                            <select id="filterGames" class="form-control">
                                <option value="">All Games</option>
                                <?php foreach ($gamesFilter as $loop): ?>
                                <option value="<?= $loop['id']; ?>"><?= $loop['games']; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="col-lg-3 col-6 select">
                            <label for="filterProvider">Filter by Provider:</label>
                            <select id="filterProvider" class="form-control">
                                <option value="">All Provider</option>
                                <?php foreach ($providerFilter as $loop): ?>
                        ...
                        <div class="col-lg-3 col-6 select">
                            ...
                            <select id="filterStatus" class="form-control">
                                ...
                                <?php foreach ($statusFilter as $loop): ?>
                                <option value="<?= $loop['status']; ?>"><?= $loop['status']; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
