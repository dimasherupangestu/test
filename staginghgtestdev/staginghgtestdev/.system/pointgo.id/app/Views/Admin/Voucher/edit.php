										...
										<div class="card">
											<div class="card-body">
												...
												<form action="" method="POST" enctype="multipart/form-data">
													...
													<div class="form-group row" id="type_custom2">
														<label class="col-form-label col-md-4 text-white">Pilih Level Membership</label>
														<div class="col-md-8">
															<?php
															
                                                            $selected_levels = [];
                                                            if ($voucher['type_produk'] == 'custom' OR $voucher['type_produk'] == 'all') {
                                                            ...
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input" 
                                                                       ...
                                                                       name="level[]" 
                                                                       value="Member" 
                                                                       <?= in_array('Member', $selected_levels) ? 'checked' : ''; ?>>
                                                                <label class="custom-control-label text-white" for="level-Member" style="padding-top: 4px;">
                                                                Member Biasa</label>
                                                            </div>
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input" id="level-Publik" name="level[]" value="Publik" <?= in_array('Publik',$selected_levels) ? 'checked' : ''; ?>>
