    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-3">Pesanan Success Bulan Lalu</h5>
                    ...
                    <table id="table" data-search="true" data-advanced-search="true" data-id-field="id"
                        ...
                        data-auto-refresh="true" data-auto-refresh-interval="15" data-pagination="true"
                        data-filter-control="true" data-show-search-clear-button="true"
                        data-url="<?= base_url(); ?>/admin/pesanan/get_orders_data_success_last_month" data-show-export="true"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="username">Member</th>
                                <th data-field="product" data-formatter="orderFormatter">Produk</th>
              
                                    <th data-field="price">H. Jual</th>
                                    <th data-field="raw_price">H. Modal</th>
...
function orderFormatter(value, row, index) {
    var orderIdClass = '';
                    ...
                    return row.product + ' <span class="' + orderIdClass +
                        '" style="cursor: pointer" onclick="detail(\'' + row.order_id + '\')">' +
                        '<br>' + 'No Trx : ' + row.order_id + '</span>';
}
</script>
