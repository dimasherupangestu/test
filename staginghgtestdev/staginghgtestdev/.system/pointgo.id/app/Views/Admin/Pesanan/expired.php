            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <table id="table" data-search="true" data-advanced-search="true" data-id-field="id"
                        ...
                        data-url="<?= base_url(); ?>/admin/pesanan/get_orders_data_expired" data-show-export="true" 
...
function actionFormatter(value, row, index) {
    return '<a href="<?= base_url(); ?>/admin/pesanan/edit/' + row.id +
        ...
        '<button type="button" onclick="approvePending(\'<?= base_url(); ?>/admin/pesanan/approvePending/' +
            row.id +
            '\');" class="btn tomboltable btn-warning btn-sm"><i class="fa fa-check"> processing</i></button><br> ';
}
