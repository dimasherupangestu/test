    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-3">Pesanan Pending (Max 30.000 data terakhir)</h5>
                    ...
                    <table id="table" data-search="true" data-advanced-search="true" data-id-field="id"
                        ...
                        data-url="<?= base_url(); ?>/admin/pesanan/get_orders_data_pending">
                        <thead>
                            <tr>
...
function actionFormatter(value, row, index) {
    if (row.status === 'Pending') {
        return '<button type="button" onclick="approvePending(\'<?= base_url(); ?>/admin/pesanan/approvePending/' +
            ...
            '<button type="button" onclick="cancel(\'<?= base_url(); ?>/admin/pesanan/CancelPending/' +
            row.id +
