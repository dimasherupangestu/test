            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
						...
						<h5 class="mb-3"><b>TOTAL SALDO MEMBER : Rp <?= number_format($jumlah,0,',','.'); ?></b></h5>
                        <a href="<?= base_url(); ?>/admin/pengguna/add" class="btn btn-primary">Tambah Akun</a>
                        <?= alert(); ?>
                    </div>

                    <div class="table-responsive table-white">
                        <table id="pengguna-table" class="table table-striped" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Username</th>
...
$(document).ready(function() {
    ...
    $('#pengguna-table').DataTable({
        ajax: {
            url: '<?= base_url(); ?>/admin/pengguna/get_pengguna_data',
            dataSrc: ''
        },
        columns: [{
                data: 'no'
