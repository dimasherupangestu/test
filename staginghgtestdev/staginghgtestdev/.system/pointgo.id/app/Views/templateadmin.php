...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        .alert-success {
            --bs-alert-color: #12703a;
            --bs-alert-bg: #d1ecdd;
            --bs-alert-border-color: #1aa053;
        }
    
        .alert-danger {
            --bs-alert-color: #862317;
            --bs-alert-bg: #f2d6d3;
...
.table>:not(caption)>*>* {
    ...
    <body id="adminNew">
            ...
            <div class="sidebar-body pt-0 data-scrollbar">
                <div class="sidebar-list">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <?php if ($admin['level'] !== 'Customer Service' && $admin['level'] !== 'Product Development'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Home' ? 'active' : ''; ?>" href="<?= base_url(); ?>/admin/Home">
                                <i class="icon">
                                ...
                                <span class="item-name">Dashboard 1</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'New Dashboard' ? 'active' : ''; ?>" href="<?= base_url(); ?>/admin/newdashboard">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.14373 20.7821V17.7152C9.14372 16.9381 9.77567 16.3067 10.5584 16.3018H13.4326C14.2189 16.3018 14.8563 16.9346 14.8563 17.7152V20.7732C14.8562 21.4473 15.404 21.9951 16.0829 22H18.0438C18.9596 22.0023 19.8388 21.6428 20.4872 21.0007C21.1356 20.3586 21.5 19.4868 21.5 18.5775V9.86585C21.5 9.13139 21.1721 8.43471 20.6046 7.9635L13.943 2.67427C12.7785 1.74912 11.1154 1.77901 9.98539 2.74538L3.46701 7.9635C2.87274 8.42082 2.51755 9.11956 2.5 9.86585V18.5686C2.5 20.4637 4.04738 22 5.95617 22H7.87229C8.19917 22.0023 8.51349 21.8751 8.74547 21.6464C8.97746 21.4178 9.10793 21.1067 9.10792 20.7821H9.14373Z" fill="currentColor"></path>
                                    </svg>
                                </i>
                                <span class="item-name">Dashboard 2</span>
                            </a>
                        </li>
                        <?php endif ?>
                        <?php if ($admin['level'] == 'Superadmin' || $admin['level'] == 'Product Development'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Konfigurasi' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/konfigurasi">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php if ($admin['level'] !== 'Product Development') : ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Admin' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/Admin">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php endif; ?>
                        ...
                        <?php if ($admin['level'] !== 'Customer Service'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Games' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/games">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Kategori' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/kategori">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="item-name">Kategori Games</span>
                            </a>
                        </li>
                       <li class="nav-item">
                            <a class="nav-link <?= $title == 'Produk' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/Produk">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul class="sub-nav collapse show" id="sidebar-special" data-bs-parent="#sidebar-menu" style="">
                                <li class="nav-item">
                                    <a class="nav-link <?= $title == 'Produk Vocagame' ? 'active' : ''; ?>" href="
                                        <?= base_url(); ?>/admin/produk/vocagametable">
                                        <i class="icon">
                                        ...
                                        <span class="item-name">Vocagame</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                         <li class="nav-item">
                        <a class="nav-link <?= $title == 'Kategori Produk' ? 'active' : ''; ?>" href="
                            <?= base_url(); ?>/admin/Produk/category">
                            <i class="icon">
                   ...
                   <?php if ($admin['level'] !== 'Product Development') : ?>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link " static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Pesanan (7 Hari Terakhir)</span>

                        </a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link <?= $title == 'Pesanan' ? 'active' : ''; ?>"" href="
                            <?= base_url(); ?>/admin/pesanan">
                            <i class="icon">
                                <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <ul class="sub-nav collapse show" id="sidebar-special" data-bs-parent="#sidebar-menu" style="">
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Pesanan Pending' ? 'active' : ''; ?>"" href="
                                    <?= base_url(); ?>/admin/pesanan/pending">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-count text-warning pending-count"></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Pesanan Processing' ? 'active' : ''; ?>"" href="
                                    <?= base_url(); ?>/admin/pesanan/processing">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">Processing</span>
                                    <span class="item-count text-warning processing-count"></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Pesanan Canceled' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/pesanan/canceled">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <!--<span class="item-count text-danger canceled-count"></span>-->
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Pesanan Expired' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/pesanan/expired">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Pesanan Success' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/pesanan/success">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">Success</span>
                                    <!--<span class="item-count text-success success-count"></span>-->
                                </a>
                            </li>
                            <hr class="hr-horizontal" >
                            <li class="nav-item" >
                                <a class="nav-link <?= $title == 'Pesanan Topup' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/pesanan/topup">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">All Pesanan Otomatis / Lapak</span>
                                </a>
                            </li>
                            <li class="nav-item" >
                                <a class="nav-link <?= $title == 'Pesanan Manual' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/pesanan/manual">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <span class="item-name">All Pesanan Manual</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        <li class="nav-item static-item" hidden>
                            <a class="nav-link static-item disabled" href="#" tabindex="-1">
                                <span class="default-icon">Laporan/Rekap Bulanan</span>

                            </a>
                        </li>
                        <li class="nav-item" hidden>
                            <a class="nav-link <?= $title == 'Rekap' ? 'active' : ''; ?>" >
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul class="sub-nav collapse show" id="sidebar-special" data-bs-parent="#sidebar-menu" style="">
                                <li class="nav-item">
                                    <a class="nav-link <?= $title == 'Pesanan successthismonth' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/pesanan/successthismonth">
                                        <i class="icon">
                                        ...
                                        <i class="sidenav-mini-icon"> B </i>
                                        <span class="item-name">Success Bulan Ini</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= $title == 'Pesanan alldatathismonth' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/pesanan/alldatathismonth">
                                        <i class="icon">
                                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <i class="sidenav-mini-icon"> B </i>
                                        <span class="item-name">All Pesanan Bulan Ini</span>
                                    </a>
                                </li>
                                
                                
                                <li class="nav-item">
                                    <a class="nav-link <?= $title == 'Pesanan successlastmonth' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/pesanan/successlastmonth">
                                        <i class="icon">
                                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <i class="sidenav-mini-icon"> B </i>
                                        <span class="item-name">Success Bulan Lalu</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= $title == 'Pesanan alldatalastmonth' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/pesanan/alldatalastmonth">
                                        <i class="icon">
                                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <i class="sidenav-mini-icon"> B </i>
                                        <span class="item-name">All Pesanan Bulan lalu</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Pengguna' ? 'active' : ''; ?>" href="<?= base_url(); ?>/admin/pengguna">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php if ($admin['level'] !== 'Admin' && $admin['level'] !== 'Customer Service') : ?>
                        <li class="nav-item">
                        <a class="nav-link <?= $title == 'Topup' ? 'active' : ''; ?>" href="
                            <?= base_url(); ?>/admin/topup">
                            <i class="icon">
                                <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                        ...
                        <ul class="sub-nav collapse show" id="sidebar-special" data-bs-parent="#sidebar-menu" style="">
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Topup Pending' ? 'active' : ''; ?>"" href="
                                    <?= base_url(); ?>/admin/topup/pending">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                    ...
                                    <i class="sidenav-mini-icon"> B </i>
                                    <span class="item-name">Pending</span>
                                    <span class="item-count text-warning pending-topup"></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Topup Canceled' ? 'active' : ''; ?>"" href="
                                    <?= base_url(); ?>/admin/topup/canceled">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= $title == 'Topup Success' ? 'active' : ''; ?>" href="
                                    <?= base_url(); ?>/admin/topup/success">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $title == 'Membership Level' ? 'active' : ''; ?>"  href="<?= base_url(); ?>/admin/memberlevel">
                            <i class="icon">
                                <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                                <path opacity="0.4" d="M6.447 22C3.996 22 2 19.9698 2 17.4755V12.5144C2 10.0252 3.99 8 6.437 8L17.553 8C20.005 8 22 10.0302 22 12.5256V17.4846C22 19.9748 20.01 22 17.563 22H16.623H6.447Z" fill="currentColor"></path>                                <path d="M11.455 2.22103L8.54604 5.06682C8.24604 5.36094 8.24604 5.83427 8.54804 6.12742C8.85004 6.41959 9.33704 6.41862 9.63704 6.12547L11.23 4.56623V6.06119V14.4515C11.23 14.8654 11.575 15.2014 12 15.2014C12.426 15.2014 12.77 14.8654 12.77 14.4515V4.56623L14.363 6.12547C14.663 6.41862 15.15 6.41959 15.452 6.12742C15.603 5.98036 15.679 5.78849 15.679 5.59566C15.679 5.40477 15.603 5.21291 15.454 5.06682L12.546 2.22103C12.401 2.07981 12.205 1.99995 12 1.99995C11.796 1.99995 11.6 2.07981 11.455 2.22103Z" fill="currentColor"></path>                                
                                </svg>                            
                            </i>
                            <span class="item-name">Membership Level</span>
                        </a>
                    </li>
                        <li>
                            <hr class="hr-horizontal">
                    ...
                    <?php endif; ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Metode' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/metode">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Postingan' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/postingan">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'Voucher' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/voucher">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $title == 'News' ? 'active' : ''; ?>" href=" <?= base_url(); ?>/admin/news">
                                <i class="icon">
                                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.8843 5.11485H13.9413C13.2081 5.11969 12.512 4.79355 12.0474 4.22751L11.0782 2.88762C10.6214 2.31661 9.9253 1.98894 9.19321 2.00028H7.11261C3.37819 2.00028 2.00001 4.19201 2.00001 7.91884V11.9474C1.99536 12.3904 21.9956 12.3898 21.9969 11.9474V10.7761C22.0147 7.04924 20.6721 5.11485 16.8843 5.11485Z" fill="currentColor"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20.8321 6.54353C21.1521 6.91761 21.3993 7.34793 21.5612 7.81243C21.8798 8.76711 22.0273 9.77037 21.9969 10.7761V16.0292C21.9956 16.4717 21.963 16.9135 21.8991 17.3513C21.7775 18.1241 21.5057 18.8656 21.0989 19.5342C20.9119 19.8571 20.6849 20.1553 20.4231 20.4215C19.2383 21.5089 17.665 22.0749 16.0574 21.9921H7.93061C6.32049 22.0743 4.74462 21.5086 3.55601 20.4215C3.2974 20.1547 3.07337 19.8566 2.88915 19.5342C2.48475 18.8661 2.21869 18.1238 2.1067 17.3513C2.03549 16.9142 1.99981 16.4721 2 16.0292V10.7761C1.99983 10.3374 2.02357 9.89902 2.07113 9.46288C2.08113 9.38636 2.09614 9.31109 2.11098 9.23659C2.13573 9.11241 2.16005 8.99038 2.16005 8.86836C2.25031 8.34204 2.41496 7.83116 2.64908 7.35101C3.34261 5.86916 4.76525 5.11492 7.09481 5.11492H16.8754C18.1802 5.01401 19.4753 5.4068 20.5032 6.21522C20.6215 6.3156 20.7316 6.4254 20.8321 6.54353ZM6.97033 15.5412H17.0355H17.0533C17.2741 15.5507 17.4896 15.4717 17.6517 15.3217C17.8137 15.1716 17.9088 14.963 17.9157 14.7425C17.9282 14.5487 17.8644 14.3577 17.7379 14.2101C17.5924 14.0118 17.3618 13.8935 17.1155 13.8907H6.97033C6.51365 13.8907 6.14343 14.2602 6.14343 14.7159C6.14343 15.1717 6.51365 15.5412 6.97033 15.5412Z" fill="currentColor"></path>
        ...
        <script src="https://unpkg.com/bootstrap-table@1.21.0/dist/extensions/filter-control/bootstrap-table-filter-control.min.js">
        </script>
    ...
    $(document).ready(function() {
        function getOrderCounts() {
            $.ajax({
                url: '<?= base_url(); ?>/admin/pesanan/getOrderCounts',
                method: 'GET',
                dataType: 'json',
                success: function(response) {
                    $('.pending-count').text(response.pendingCount);
                    $('.pending-topup').text(response.pendingTopup);
                    $('.processing-count').text(response.processingCount);
                    $('.canceled-count').text(response.canceledCount);
                    $('.success-count').text(response.successCount);
                },
    ...
    function approve(link) {
        Swal.fire({
            title: 'Anda yakin?',
            text: "Pesanan akan menjadi Sukses",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
