			...
			<div class="content" style="min-height: 580px;">
			    <div class="container">
			    	<div class="row justify-content-center">
					    <div class="col-lg-9">
					    	<div class="pt-3 pb-4">
					            <h5 hidden>Register Reseller</h5>
					        ...
					        <div class="pb-3">
					            <div class="section">
					                <div class="card-body">
                                       ...
                                       <h5 class="text-center pb-3">Daftar Reseller</h5>
                                            ...
                                            <button type="submit" name="tombol" value="submit" class="btn btn-primary btn-block">Daftar Akun Reseller</button>
                                        </form>
                                    ...
                                    <div class="d-flex justify-content-center flex-col">
                                        <a href="<?= base_url(); ?>/loginreseller" class="btn btn-primary masuk normal">Masuk Reseller</a>
                                    </div>
					        </div>
					    </div>
					</div>
