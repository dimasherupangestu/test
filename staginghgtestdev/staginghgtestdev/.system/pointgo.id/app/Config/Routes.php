...
$routes->match(['get', 'post'], '/kalkulatorzodiac', 'Pages::kalkulatorzodiac');
$routes->match(['get', 'post'], '/news', 'Pages::news');
...
$routes->match(['get', 'post'], '/leaderboard', 'Pages::topsepuluh');
...
$routes->match(['get', 'post'], '/admin/produk/vocagametable', 'Admin\Produk::vocagametable');
...
$routes->match(['get', 'post'], '/user/editprofile', 'User::editprofile');
$routes->match(['get', 'post'], '/user/topup/(:any)', 'User::topup/$1');
$routes->match(['get', 'post'], '/user/order/(:any)/(:any)', 'User::order/$1/$2');
$routes->match(['get', 'post'], '/user/membership', 'User::membership');
$routes->match(['get', 'post'], '/user/membership/(:any)', 'User::membership/$1');
